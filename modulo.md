...
$bg-card: #1e1e1e;
$bg-input: #2a2a2a;
$primary-brown: #d4af37; /* Dorado elegante */
            ...
            <div class="o_portal_wrapper">
                ...
                <header class="o_portal_header">
                    ...
                    <div class="d-flex align-items-center gap-4">
                        ...
                        <div class="po-info">
                            <div><span class="label" data-i18n="po_label">Orden de Compra:</span> <span class="value" t-esc="picking.origin or 'N/A'"/></div>
                            <div><span class="label" data-i18n="receipt_label">Recepción:</span> <span class="value" t-esc="picking.name"/></div>
                        </div>
                    </div>
                </header>
                ...
                <div class="submit-footer">
                    <div class="summary">
                        <span data-i18n="footer_total_plates">Total Placas:</span> <span id="total-plates">0</span> | 
                        <span data-i18n="footer_total_area">Total Área:</span> <span id="total-area">0.00</span> m²
                    </div>
