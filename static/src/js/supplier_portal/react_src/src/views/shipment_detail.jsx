    ...
    <div className="card">
      <div className="card-head">
        <div>
          ...
          <p className="sub">Sube los documentos legales y de calidad que acompañan este embarque.</p>
        </div>
      </div>
              ...
              {doc ? (
                <div className="doc-row" style={{padding: '8px 10px'}}>
                  ...
                  <div className="doc-meta">
                    ...
                    <div className="meta">{(doc.size/1024).toFixed(0)} KB · {doc.uploaded}</div>
                  </div>
                  <Btn variant="ghost" size="sm" icon="eye"/>
                  <Btn variant="ghost" size="sm" icon="trash" className="btn-danger-ghost"/>
                </div>
              ) : (
                <Btn variant="secondary" icon="upload" size="sm">Subir PDF</Btn>
              )}
            </div>
          );
        })}
