    ...
    (draft.blocks || []).forEach((b, bIdx) => {
        ...
        if (mode === 'placa') {
            for (let i = 0; i < (+b.count || 0); i++) {
                ...
                const base = { id, product_id: b.product || product.id, tipo, block: b.name, atado: '', plate: '', ref: product.ref || '', thickness: 2, h: 0, w: 0, quantity: 0, weight: 0, notes: '', grupo: '', pedimento: '', container: b.container || defaultContainer, container_id: false, pi_header_id: b.pi_header_id || false, photo: false, errors: [], blockStart: i === 0 };
                        ...
                        (mode === 'placa' && React.createElement(React.Fragment, null,
                            ...
                            React.createElement("div", { className: "block-fields-row" },
                                React.createElement(Field, { label: "Placas enviadas", required: true },
                                    React.createElement(Input, { mono: true, type: "number", min: 1, value: b.count || '', placeholder: '18', onChange: (e) => updBlock(b.id, { count: Math.max(0, +e.target.value || 0) }) })),
